...
class Network(object):
    def __init__(self, sizes, trained_weights=[], trained_biases=[]):
        self.num_layers = len(sizes)
        self.sizes = sizes
        if trained_weights != [] and trained_biases != []:
    ...
    def SGD(self, training_data, epochs, mini_batch_size, eta, test_data = None):
        ...
        np.save(os.path.join(__location__, "network_weights.npy"),
                np.array(self.weights, dtype="object"),
                allow_pickle=True)
        np.save(os.path.join(__location__, "network_biases.npy"),
    ...
    def directly_test(self, digit_data):
        return np.argmax(self.feed_forward(digit_data))
